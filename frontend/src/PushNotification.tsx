import { getMessaging, getToken, onMessage, deleteToken, type Messaging, type MessagePayload, type NextFn, type Observer } from 'firebase/messaging';
...
export const onForegroundNotification = (callback: NextFn<MessagePayload> | Observer<MessagePayload>) => {
    if (messaging) {
